...
<head>
<meta charset="utf-8">
<title>moto LINK 管理ページ 投稿の編集 </title>
<style>
...
<form method="post">
	...
	<div>
		...
		<textarea id="message" name="message"><?php if( !empty($message_data['message']) ){ echo $message_data['message']; } 
